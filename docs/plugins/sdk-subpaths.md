...
<AccordionGroup>
  <Accordion title="Channel subpaths">
    ...
    | `plugin-sdk/question-gateway-runtime` | Resolve runtime-authored `ask_user` choices and store-bound secret answers through the Gateway from channel interaction handlers |
