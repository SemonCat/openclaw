    ...
    expect(output.content).toEqual([
      {
        ...
        partialArgs: JSON.stringify({ path: padding + emoji }),
      },
    ]);
  });
    ...
    expect(output.content).toEqual([
      {
        ...
        partialArgs: '{"path":"/tmp/fragmented.md"}',
      },
    ]);
  });
    ...
    expect(output.content).toEqual([
      {
        ...
        partialArgs: '{"text":"literal <｜DSML｜tool_calls> marker"}',
      },
    ]);
  });
